        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <a className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-800 dark:hover:bg-gray-600 `} href="/admin"
                >Home Admin</a>
              </li>
              <li>
                <a
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-800 dark:hover:bg-gray-600 ${selected === 'Dashboard' ? 'bg-gray-800 dark:bg-gray-600' : ''}`}
                  href="#"
                  onClick={() => handleMenuItemClick(selected === 'Dashboard' ? '' : 'Dashboard')}
                >
                  ...
                  Product
                  <svg className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${selected === 'Dashboard' ? 'rotate-180' : ''}`} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={selected === 'Dashboard' ? 'block' : 'hidden'}>
                  <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                    <li>
                      <a className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white" href="/admin/product/create">Add Product</a>
                    </li>
                  </ul>
                </div>
              </li>
