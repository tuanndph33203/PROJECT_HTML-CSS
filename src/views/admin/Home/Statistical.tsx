...
function Statistical() {
  ...
  return (
    <div className="py-5 md:px-8 xl:px-10 bg-[#1A222C] text-white">
      ...
      <div className="rounded-sm border border-gray-600 bg-[#24303F] shadow-default py-3  dark:bg-boxdark">
        <div className="md:px-6 xl:px-7.5 mb-4">
          <section className="">
            <div className="">
        ...
        <div className="grid grid-cols-6 border-t border-gray-600 py-5 px-4 sm:grid-cols-8 md:px-6 2xl:px-7.5 ">
        ...
        {products!.map((value: IProduct, index: number): any => {
          return (
            <div key={index} className="grid grid-cols-6 border-t  border-gray-600 py-4.5 px-4 sm:grid-cols-8 md:px-6 2xl:px-7.5">
              <div className="col-span-3 flex items-center">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                  <div className="h-12.5 w-15 rounded-md">
                    <img className="w-20" src={`/assets/image/product/${value.image}`} alt="Product" />
                  </div>
                  <p className="font-medium text-sm text-black dark:text-white">{value.name}</p>
                </div>
              </div>
              <div className="col-span-2 hidden items-center sm:flex">
              ...
              <div className="col-span-1 flex items-center">
                <p className="font-medium text-sm text-black dark:text-white">{value.inStock}</p>
              </div>
              <div className="col-span-1 flex items-center">
                <Link to={`/admin/product/${value.tag}`} className="hover:text-primary mr-4">
                ...
                <button className="hover:text-primary" onClick={() => handleDelete(value)}>
                  <svg className="fill-current" width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
